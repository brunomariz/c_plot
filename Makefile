...
HDRS := inc/c_plot.h examples/example_render.h c_structures/inc/c_structures.h
...
SRCS := src/c_plot.c src/render.c examples/example_render.c c_structures/src/s_list.c c_structures/src/tree.c $(MAIN) 
