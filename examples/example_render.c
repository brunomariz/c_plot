...
void render_circles(SDL_Renderer *renderer)
{
    ...
    int thick_border = 1;
    c_plot_draw_circumference(renderer, 50, 50, 100, white, thick_border);
    c_plot_draw_circumference(renderer, 200, 200, 50, white, thick_border);
    c_plot_draw_circumference(renderer, 300, 400, 20, white, thick_border);
    c_plot_draw_circumference(renderer, 400, 50, 10, white, thick_border);
    c_plot_draw_circumference(renderer, 500, 10, 20, white, thick_border);
}
...
void render_exemple_tree(SDL_Renderer *renderer)
{
    ...
    // Draw nodes
    c_plot_draw_circumference_polar(renderer, 0, 0, 5, white);
    c_plot_draw_circumference_polar(renderer, 2 * pi / 3, 40, 5, white);
    c_plot_draw_circumference_polar(renderer, 4 * pi / 3, 40, 5, white);
    c_plot_draw_circumference_polar(renderer, 6 * pi / 3, 40, 5, white);
    c_plot_draw_circumference_polar(renderer, pi, 80, 5, white);
    // Draw connectors
    c_plot_draw_line_polar(renderer, 0, 0, 2 * pi / 3, 40, white);
    c_plot_draw_line_polar(renderer, 0, 0, 4 * pi / 3, 40, white);
    c_plot_draw_line_polar(renderer, 0, 0, 6 * pi / 3, 40, white);
    c_plot_draw_line_polar(renderer, 2 * pi / 3, 40, pi, 80, white);
}
